...
{
    // 【核心骨架】使用 TI 标准的组中断判定，获取当前究竟是哪个外设模块触发了 GROUP1 中断
    switch (DL_Interrupt_getPendingGroup(DL_INTERRUPT_GROUP_1)) {
        
        #if defined GPIO_MULTIPLE_GPIOA_INT_IIDX
        case GPIO_MULTIPLE_GPIOA_INT_IIDX:
            // 如果是 GPIOA 模块引发的中断，进一步读取 GPIOA 的具体引脚标志位
            switch (DL_GPIO_getPendingInterrupt(GPIOA))
            {
                /* ========================================================
                 * 1. 【合并：来自第一个代码】处理 GPIOA 上的 左轮编码器 + 按键
                 * ======================================================== */
                ...
                /* ========================================================
                 * 2. 【合并：来自第二个代码】处理 GPIOA 上的 传感器(MPU6050等)
                 * ======================================================== */
        ...
        case GPIO_MULTIPLE_GPIOB_INT_IIDX:
            // 如果是 GPIOB 模块引发的中断，进一步读取 GPIOB 的具体引脚标志位
            switch (DL_GPIO_getPendingInterrupt(GPIOB))
            {
                /* ========================================================
                 * 3. 【合并：来自第一个代码】处理 GPIOB 上的 右轮编码器
                 * ======================================================== */
                ...
                /* ========================================================
                 * 4. 【合并：来自第二个代码】处理 GPIOB 上的 传感器(MPU6050等)
                 * ======================================================== */
        ...
        /* ========================================================
         * 5. 【合并：来自第二个代码】处理非多路复用的独立传感器组中断源
         * ======================================================== */
